...
Que se aprendio:
- Usar las variables: let, var y const de Javascript,
- Declarar varibale usando camelCase,
- Asginar valor,
...
* Este ejercicio pertenece al curso de Javascript desde cero de todocode.
